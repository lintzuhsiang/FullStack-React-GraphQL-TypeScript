...
const sendEmails_1 = require("../util/sendEmails");
...
let UserResolver = class UserResolver {
    ...
    forgetPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis.set(constants_1.FORGET_PASSWORD_PREFIX + token, user.id, "ex", 86400 * 3 * 1000);
    ...
    register(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if ((_a = err.detail) === null || _a === void 0 ? void 0 : _a.includes("already exists")) {
                    return {
                        errors: [
                            {
                                field: "username",
    ...
    changePassword(token, newPassword, { redis, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield Users_1.User.findOne({ id: parseInt(userId) });
            if (!user) {
                return {
                    errors: [
                        {
            ...
            yield Users_1.User.update({ id: parseInt(userId) }, {
